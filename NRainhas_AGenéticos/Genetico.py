...
class Population:
    ...
    def crossing(self, individual_one=None, individual_two=None):  # consertar repetição linha
    ...
    def reproduction(self):
        ...
        for i in range(self.size/2):
            ...
            new_individuals.extend(self.crossing(individuals[0], individuals[1]))
    ...
    def kill(self, population, sacrifice):
        ...
        costs.sort(key=operator.itemgetter(1))
        for i in range(sacrifice):
            self.population.pop(costs[i][1])
